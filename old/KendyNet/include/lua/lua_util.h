...
#define CALL_LUA_FUNC(LUASTATE,FUNCNAME,RET)\
		({\
			...
			int __result = lua_pcall(LUASTATE,0,RET,0);\
		__result;})
...
#define CALL_LUA_FUNC1(LUASTATE,FUNCNAME,RET,ARG1)\
		({\
			lua_getglobal(LUASTATE,FUNCNAME);\
			ARG1;\
			int __result = lua_pcall(LUASTATE,1,RET,0);\
		__result;})
...
#define CALL_LUA_FUNC2(LUASTATE,FUNCNAME,RET,ARG1,ARG2)\
		({\
			lua_getglobal(LUASTATE,FUNCNAME);\
			ARG1;ARG2;\
			int __result = lua_pcall(LUASTATE,2,RET,0);\
		__result;})
...
#define CALL_LUA_FUNC3(LUASTATE,FUNCNAME,RET,ARG1,ARG2,ARG3)\
		({\
			lua_getglobal(LUASTATE,FUNCNAME);\
			ARG1;ARG2;ARG3;\
			int __result = lua_pcall(LUASTATE,3,RET,0);\
		__result;})
		
#define CALL_LUA_FUNC4(LUASTATE,FUNCNAME,RET,ARG1,ARG2,ARG3,ARG4)\
		({\
			lua_getglobal(LUASTATE,FUNCNAME);\
			ARG1,ARG2,ARG3,ARG4;\
			int __result = lua_pcall(LUASTATE,4,RET,0);\
		__result;})
		
#define CALL_LUA_FUNC5(LUASTATE,FUNCNAME,RET,ARG1,ARG2,ARG3,ARG4,ARG5)\
		({\
			lua_getglobal(LUASTATE,FUNCNAME);\
...
#define CALL_LUA_FUNC6(LUASTATE,FUNCNAME,RET,ARG1,ARG2,ARG3,ARG4,ARG5,ARG6)\
		({\
			lua_getglobal(LUASTATE,FUNCNAME);\
...
#define CALL_OBJ_FUNC(OBJ,FUNCNAME,RET)\
		({\
			...
			lua_rawgeti(OBJ->L,LUA_REGISTRYINDEX,OBJ->rindex);\
			const char *err = NULL;\
			if(lua_pcall(OBJ->L,1,RET,0)){\
				err = lua_tostring(OBJ->L,1);\
				lua_pop(OBJ->L,1);\
			}\
		err;})
