...
kn_sockaddr*  kn_stream_conn_local_addr(kn_stream_conn_t c){
	return kn_fd_local_addr(c->fd);
}

kn_sockaddr*  kn_stream_conn_remote_addr(kn_stream_conn_t c){
	return kn_fd_remote_addr(c->fd);
}
