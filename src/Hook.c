...
{ 
    ...
    unsigned char* func = (unsigned char*)address;
    ...
    return func - (unsigned char*)address;
...
int GetInstructionBoundary(void* function, int count)
{
    ...
    {
        unsigned char* func = (unsigned char*)function + boundary;
        boundary += GetInstructionSize(func,NULL,NULL);
    }
...
void AdjustRelativeJumps(void* function, int length, int offset)
{
    ...
    unsigned char* p = (unsigned char*)(function);
...
int GetIsHooked(void* function, void* hook)
{
    ...
    unsigned char* address = (unsigned char*)(ReadJump(function));
    ...
    return ReadJump(address + 13) == hook ? 1 : 0;
